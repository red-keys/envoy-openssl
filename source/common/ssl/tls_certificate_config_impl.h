...
public:
  ...
  envoy::extensions::transport_sockets::tls::v3::TlsCertificate::CertificateUsage certificateUsage() const override {
...
private:
  ...
  const envoy::extensions::transport_sockets::tls::v3::TlsCertificate::CertificateUsage certificate_usage_;
};
